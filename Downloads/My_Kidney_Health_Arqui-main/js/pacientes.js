  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function actualizarTabla(pacientes) {
      ...
      pacientes.forEach(function(paciente) {
        ...
        nombresCell.style.textAlign = 'center';
        var ultimaCitaCell = document.createElement('td');
        ultimaCitaCell.textContent = paciente.cedula;
        ultimaCitaCell.style.textAlign = 'center';
        ...
        verButton.style.textAlign = 'center';
        var eliminarButton = document.createElement('button');
        eliminarButton.textContent = 'Inhabilitar';
        eliminarButton.style.marginLeft='10px'
        eliminarButton.style.textAlign = 'center';
        var editarButton = document.createElement('button');
        editarButton.textContent = 'Editar';
        editarButton.style.marginLeft='10px'
        editarButton.style.textAlign = 'center';
